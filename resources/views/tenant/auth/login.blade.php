@extends("tenant.layout.auth")
@section("content")
    <!-- Login Section -->
    <div class="container-fluid mb-5 py-5">
        <div class="row">
            <div class="col-lg-4 col-sm-4 col-12 offset-lg-4 offset-sm-4">
                <form method="post" action="{{ route('tenant.login') }}" class="p-4 bgGray box-shadow mt-5">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block btn-form-submit">Login</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
