...
<!-- Content -->
    <div class="content container-fluid">
        <span class="float-right">Sales Enquiry List</span>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sales Enquiry List</li>
            </ol>
        </nav>
...
@section('script')
  <script>
	  $(document).ready(function(){
        ...
        {
            return `<a  href="javascript:void(0)" data-id="${data.id}" class="btn btn-soft-primary"><i class="fa fa-edit text-white"></i></a>`;
        }
        function renderActionBtn(data)
        {
            ...
            return `<a  href="${data.create_buyer_url}" data-id="${data.id}" class="btn btn-soft-primary"><i class="fa fa-sign-in-alt text-white"></i></a>
<a title="Send current enquiry to archive folder"  href="javascript:void(0)" data-id="${data.id}" class="btn btn-soft-danger deleteBtn"><i class="fa fa-file-archive text-white"></i></a>`;
        }
        ...
        let datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
            ...
            },columns : [{ data : "created_at", name : "created_at"},
                                { data : "name", name : "name"},
