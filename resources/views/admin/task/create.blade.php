...
<!-- Content -->
    <div class="content container-fluid">
        <span class="float-right">Create/Assign Task</span>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Create/Assign Task</li>
            </ol>
        </nav>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    <div class="form-group">
                        <label for="assignee_id">User/Employee</label>
                            ...
                            <select  class="js-select2-custom" name="assignee_id" id="assignee_id">
                            </select>
                    </div>
                </div>
          </div>
      ...
      <div class="card card-info">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                    <div class="form-group">
                        ...
                        <select class="js-select2-custom" name="task_title" id="task_title"></select>
                    </div>
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                     <div class="form-group">
                        <label for="priority">Priority</label>
                        <select  class="js-select2-custom" name="priority" id="priority">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control js-flatpickr flatpickr-custom" name="deadline" id="deadline" data-hs-flatpickr-options='{
                                             "dateFormat": "d-m-Y"
