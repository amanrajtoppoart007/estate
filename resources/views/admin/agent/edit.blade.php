...
@section('content')
 <div class="card">
     <div class="card-body">
         {{Form::open(['url'=>route('agent.update',$data->id),'id'=>'edit_data_form'])}}
                ...
                <div class="text-center">
                  <div class="user_photo">
                      @php
                         if(!empty($data->photo))
                         {
                             $img = route('get.doc',base64_encode($data->photo));
                         }
                         else 
                         {
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="bank_ifsc_code" id="bank_ifsc_code" value="{{$data['bank_ifsc_code']}}">
              </div>
          </div>
          ...
          <div class="form-group col-md-4">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="bank_account" id="bank_account" value="{{$data['bank_account']}}">
              </div>
          </div>
          <div class="form-group col-md-4">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="banking_name" id="banking_name" value="{{$data['banking_name']}}">
              </div>
          </div>
        </div>
       ...
       $(document).ready(function(){
           ...
           function render_image(input) 
            ...
            $("#edit_data_form").on('submit',function(e){
                e.preventDefault();
                var url = "{{route('agent.update',$data->id)}}";
