...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <input type="hidden" name="tenancy_type" id="tenancy_type" value="">

            <input type="hidden" name="rent_breakdown_id" value="">
            <div class="card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="remote_deposit">
                                        <input type="text" name="remote_deposit" id="remote_deposit"
                                               value="{{$breakdown['remote_deposit']}}">
                                    </label>
                                </td>
                            </tr>
                            <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#add_data_form').on("submit", function (event) {
                ...
                let url = "{{route('create.rent.breakdown')}}";
