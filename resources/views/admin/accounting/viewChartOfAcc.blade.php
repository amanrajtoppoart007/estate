...
@section('breadcrumb')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">View {{$account->name}} Transactions in system</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="table-responsive datatable-custom">
                     ...
                     "pagination": "datatablePagination"
                            ...
                            <tr>
                                ...
                                <th>S No.</th>
                                <th class="table-column-pl-0">Remark</th>
                                <th>Credit</th>
                                <th>Debit</th>
                                <th>Action</th>
...
<script>
    ...
    let fetchlink   =  "{{route('acc.bank.tansactions')}}";
    let viewInvoiceRoute    = "{{route('acc.invoice.view',['invoice'=>'123'])}}";
    let createnewAcc    = "{{route('acc.bank.store')}}";
    let viewInvoice = viewInvoiceRoute.slice(0,-3);
    $(document).ready(function(){
        ...
        let datatable = $.HSCore.components.HSDatatables.init($('#datatables'), {
            dom: 'Bfrtip',
            buttons: [
                {
                    extend: 'copy',
