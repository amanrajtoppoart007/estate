...
@section('breadcrumb')
  <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Task to bill</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active">Task Bill</li>
              </ol>
            </div>
          </div>
        </div>
...
@section('content')
        ...
        <div class="card">
            <div class="card-header"> <h6> <strong>Create task bill</strong> </h6> </div>
            <div class="card-body table-responsive">
              <form id="TaskBillform">
                <div class="row">
                    <div class="col-md-4"><b>Bill: {{$bill_no}}</b>
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="text" id="expected" class="form-control" name="expected" required>
...
@endsection
 ...
 <script>
   ...
   var insertBill = "{{route('task.bill.store')}}";
...
var viewInvoice = viewInvoiceRoute.slice(0,-3);
 ...
 $('#expected').datepicker({ footer: true, modal: true,format: 'dd-mm-yyyy',
   ...
   $(document).on('submit', '#TaskBillform', function(e) {  
   jQuery.ajaxSetup({
                  headers: {
    ...
    $.ajax({
        ...
        success: function(result)
        {
          ...
          if(result.status=='1'){
            alert(result.msg);
            viewInvoice
             window.location.replace(viewInvoice+result.bill);
