    ...
    <div class="js-mega-menu navbar-nav-wrap">
        <div class="navbar-brand-wrapper">
            ...
            <a class="navbar-brand" href="#" aria-label="Front">
                <img class="navbar-brand-logo" src="{{asset('assets/img/alhoor-logo.png')}}" alt="Logo">
            </a>
            ...
            <ul class="navbar-nav align-items-center flex-row">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/img/160x160/img3.jpg')}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-auto position-static">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/img/160x160/img10.jpg')}}"
                                                                     alt="Image Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-auto position-static">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/svg/brands/google.svg')}}"
                                                                     alt="Image Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-auto position-static">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/img/160x160/img7.jpg')}}"
                                                                     alt="Image Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-auto position-static">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/img/160x160/img5.jpg')}}"
                                                                     alt="Image Description">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-auto position-static">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="{{asset('theme/front/assets/img/160x160/img8.jpg')}}"
                                                                     alt="Image Description">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <li class="nav-item d-none d-sm-inline-block">
                   ...
                   "type": "css-animation"
                        ...
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="{{asset('theme/front/assets/svg/brands/atlassian.svg')}}"
                               alt="Image Description">
                        </span>
                                    ...
                                    <a class="nav-link" href="#">
                                        <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="{{asset('theme/front/assets/svg/brands/slack.svg')}}"
                               alt="Image Description">
                        </span>
                                            <div class="media-body text-truncate">
                                    ...
                                    <a class="nav-link" href="#">
                                        <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="{{asset('theme/front/assets/svg/brands/google-webdev.svg')}}"
                               alt="Image Description">
                        </span>
                                            <div class="media-body text-truncate">
                                    ...
                                    <a class="nav-link" href="#">
                                        <div class="media align-items-center">
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3" src="{{asset('theme/front/assets/svg/brands/frontapp.svg')}}"
                               alt="Image Description">
                        </span>
                                            <div class="media-body text-truncate">
                        ...
                        <span class="mr-3">
                          <img class="avatar avatar-xs avatar-4by3"
                               src="{{asset('theme/front/assets/svg/illustrations/review-rating-shield.svg')}}" alt="Image Description">
                        </span>
                                            <div class="media-body text-truncate">
                        ...
                        <span class="avatar avatar-xs avatar-soft-dark mr-3">
                          <span class="avatar-initials"><i class="tio-apps"></i></span>
                                            ...
                                            <div class="media-body text-truncate">
                                                ...
                                                <span
                                                    class="d-block font-size-sm text-body">Check out more HS products</span>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                ...
                <li class="nav-item">
                   ...
                   "type": "css-animation"
                            ...
                            <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="{{asset('theme/front/assets/img/160x160/img6.jpg')}}" alt="Image Description">
                            ...
                            <div class="dropdown-item">
                                <div class="media align-items-center">
                                    <div class="avatar avatar-sm avatar-circle mr-2">
                                        <img class="avatar-img" src="{{asset('theme/front/assets/img/160x160/img6.jpg')}}"
                                             alt="Image Description">
                                    </div>
        ...
        <div class="navbar-nav-wrap-content-left collapse navbar-collapse" id="navbarNavMenu">
            <div class="navbar-body">
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <li>
                        <a class="navbar-nav-link nav-link" href="{{route('accounting.dashboard')}}">
                            <i class="tio-home-vs-1-outlined nav-icon"></i> Dashboard
                        </a>
                    </li>
                    <!-- End Dashboards -->
                    ...
                    <li class="hs-has-sub-menu">
                        <a id="transactionDropdown" class="hs-mega-menu-invoker navbar-nav-link nav-link nav-link-toggle"
                           href="javascript:;" aria-haspopup="true" aria-expanded="false"
                           aria-labelledby="navLinkTransactionDropdown">
                            <i class="tio-pages-outlined nav-icon"></i> Transaction
                        </a>

                        <!-- Dropdown -->
                        <ul id="navLinkTransactionDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                            aria-labelledby="transactionDropdown" style="min-width: 16rem;">
                            <!-- Users -->
                            <li class="hs-has-sub-menu">
                                <a id="pagesDropdownUsers"
                                   class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle" href="javascript:;"
                                   aria-haspopup="true" aria-expanded="false" aria-controls="navLinkPagesDropdownUsers">
                                    <span class="tio-circle nav-indicator-icon"></span>Lease Contract
                                </a>
                                ...
                                <ul id="navLinkPagesDropdownUsers" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{route('contracts.lease.new')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> New Lease Contract
                                        </a>
                                    </li>
                    ...
                    <li class="hs-has-sub-menu">
                        <a id="pagesDropdown" class="hs-mega-menu-invoker navbar-nav-link nav-link nav-link-toggle"
                           ...
                           aria-labelledby="navLinkPagesDropdown">
                            <i class="tio-pages-outlined nav-icon"></i> Vouchers
                        </a>
                        ...
                        <ul id="navLinkPagesDropdown" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                            ...
                            <li class="hs-has-sub-menu">
                                <a id="pagesDropdownUsers"
                                   class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle" href="javascript:;"
                                   aria-haspopup="true" aria-expanded="false" aria-controls="navLinkPagesDropdownUsers">
                                    <span class="tio-circle nav-indicator-icon"></span>Receipt Voucher
                                </a>

                                <ul id="navLinkPagesDropdownUsers" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                                    aria-labelledby="pagesDropdownUsers" style="min-width: 16rem;">
                                    <li>
                                        <a class="dropdown-item" href="{{route('new.receipt.cash')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> New Cash Voucher
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{route('new.receipt.cheque')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> New Check Voucher
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{route('all.receipt')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> All Receipt Voucher <span
                                                class="badge badge-info badge-pill ml-1">100</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="hs-has-sub-menu">
                                <a id="pagesDropdownPaymentVoucher"
                                   class="hs-mega-menu-invoker dropdown-item dropdown-item-toggle" href="javascript:;"
                                   aria-haspopup="true" aria-expanded="false" aria-controls="navLinkPagesDropdownPaymentVoucher">
                                    <span class="tio-circle nav-indicator-icon"></span>Payment Voucher
                                </a>

                                <ul id="navLinkPagesDropdownPaymentVoucher" class="hs-sub-menu dropdown-menu dropdown-menu-lg"
                                    aria-labelledby="pagesDropdownPaymentVoucher" style="min-width: 16rem;">
                                    <li>
                                        <a class="dropdown-item" href="{{route('new.payment.cash')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> New Cash Voucher
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{route('new.payment.cheque')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> New Check Voucher
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{route('all.payment.voucher')}}">
                                            <span class="tio-circle-outlined nav-indicator-icon"></span> All Payment Voucher <span
                                                class="badge badge-info badge-pill ml-1">100</span>
                                        </a>
                                    </li>
                                </ul>
