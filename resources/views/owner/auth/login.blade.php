		...
		<div class="row">
			<div class="col-md-12 col-lg-12">
				...
				<div class="float-right color-primary">
					<h3 class="banner-title font-weight-bold">Owner Login</h3>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-md-5 col-lg-5">
				<div class="login_form">
                    ...
                    <li class="active"><a href="{{route('owner.login')}}" class="color-primary">Login</a></li>
                    ...
                    @endif
					{{Form::open(['route'=>'owner.login.submit','class'=>'form9'])}}
					  ...
					  @if (Route::has('owner.password.request'))
							<a class="color-primary d-block mt_30" href="{{ route('owner.password.request') }}">
