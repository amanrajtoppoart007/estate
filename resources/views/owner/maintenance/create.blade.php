...
@section('content')
   <div class="card">
       <div class="card-body">
           {{Form::open(['route'=>'owner.maintenance.store','id'=>'add_data_form'])}}
             <div class="row">
                              ...
                              <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                  <div class="form-group">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="text" class="form-control" name="name" id="name" value="{{auth('owner')->user()->name}}"/>
                              ...
                              <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                  <div class="form-group">
                                      ...
                                      <div class="input-group">
                                          ...
                                          <input type="text" class="form-control numeric" name="contact" id="contact" value="{{auth('owner')->user()->mobile}}"/>
                                      </div>
                                  </div>
                              </div>
                              <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#add_data_form").on('submit',function(e){
                e.preventDefault();
                let url = "{{route('owner.maintenance.store')}}";
            ...
            $("#property_id").on('change',function(e){
                ...
                let url    = "{{route('owner.get.unit.list')}}";
